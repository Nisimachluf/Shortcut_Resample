...
def torch_inference(
    ...
    device="cuda",
    fid_stats=None,
    vae_weights_path="vae_weights_torch.pt"
):
...
if __name__ == "__main__":
    ...
    def get_args():
        ...
        parser.add_argument('--vae_weights_path', type=str, default="vae_weights_torch.pt", help='Path to Torch VAE weights')
