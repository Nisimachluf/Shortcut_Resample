...
import os
os.environ["WANDB_API_KEY"] = "02332c1a7775a4c96323ac4fc6ad72b6d84f133e"
os.environ["TFDS_DATA_DIR"] = "/media/embedded/Datasets/Public/tfds/"
...
def main(_):
    ...
    if FLAGS.model.use_stable_vae:
        ...
        example_obs_shape = example_obs.shape
        print("out_channels=",example_obs_shape[-1])
